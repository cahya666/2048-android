    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                badSymptoms.gestureListener.setView(badSymptoms.getViewName(v));
                badSymptoms.gestureDetector.onTouchEvent(event);

                badSymptoms.scaleGestureListener.setView(badSymptoms.getViewName(v));
                badSymptoms.scaleGestureDetector.onTouchEvent(event);
